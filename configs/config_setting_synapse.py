...
class setting_config:
    ...
    model_config = {
        ...
        # 'load_ckpt_path': './pre_trained_weights/vssm_base_0229_ckpt_epoch_237.pth',
        # 'load_ckpt_path': '',
    ...
    batch_size = 16
    epochs = 300
    work_dir = 'results/RFAC/paper/12-19-block9/' +network + '_small_' + datasets_name + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
